...
function Carousel12({ data }) {
  ...
  return (
    <div className="flex items-center bg-gradient-to-b from-black via-darkblue to-black overflow-hidden">
      <button onClick={handlePrevious} className="absolute z-10 bg-darkblue rounded-r-full py-40 px-8 text-9xl">&lt;</button>
      ...
      <div className="flex gap-64">
        {data.map((item, index) => {
          ...
          return (
            ...
            className={`${item.backGround} duration-500 ease-in-out rounded-lg size-96 font-mono text-5xl flex justify-center items-center font-mono`}
